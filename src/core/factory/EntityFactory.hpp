...
public:
    ...
    static std::shared_ptr<Entity> CreateDrone(std::shared_ptr<Shader> shader)
    {
        ...
        auto model = ResourceManager::GetModel("LowPolyAssets/drone.obj", 0.05f, 2.2f, shader);
    ...
    static std::shared_ptr<Entity> CreatePirateShip(std::shared_ptr<Shader> shader)
    {
        ...
        auto model = ResourceManager::GetModel("/asserts/ship_pinnace_1k.fbx", 10.0f, 0.6f, shader);
